declare let ACTIVE_LEGAL_PACK: any;

export const LAW_DATE="2026-09-05";
...
export function category(id: string){
  return ACTIVE_LEGAL_PACK?.categories?.[id]||(CATEGORIES as Record<string, any>)[id]||{label:id,billable:"check",basis:"manuell prüfen",defaultRule:"area"}
}
...
export function legalDecision(source: Record<string, any>,{hasConsumption=false,assignment="house",agreement="auto"}: Record<string, any> = {}){
