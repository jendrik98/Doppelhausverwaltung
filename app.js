...
function createEmptyState(){
  return {
    ...
    meta:{appVersion:"16.0.0",createdAt:new Date().toISOString(),migratedFrom:null,revision:0,lastSavedAt:null,lastBackupAt:null,lastIntegrityCheckAt:null,errorLog:[]},
...
function normalizeState(s){
  ...
  out.meta={...base.meta,...(s?.meta||{}),appVersion:"16.0.0"};
