const CACHE="mietverwaltung-v18-assistant-preview-1";
const CORE=["./","./index.html","./style.css","./app.js?v=1710","./manifest.webmanifest","./legal-rules.json","./icon-192.png","./icon-512.png"];
