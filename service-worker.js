const CACHE="mietverwaltung-v16-0-1-e2e-hotfix";
const CORE=["./","./index.html","./style.css","./app.js?v=1601","./manifest.webmanifest","./legal-rules.json","./icon-192.png","./icon-512.png"];
