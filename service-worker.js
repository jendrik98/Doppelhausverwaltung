const CACHE="mietverwaltung-v14-navigation";
const CORE=["./","./index.html","./style.css","./app.js?v=1400","./manifest.webmanifest","./legal-rules.json","./icon-192.png","./icon-512.png"];
