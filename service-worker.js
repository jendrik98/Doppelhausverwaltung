const CACHE="mietverwaltung-v16-premium-final";
const CORE=["./","./index.html","./style.css","./app.js?v=1600","./manifest.webmanifest","./legal-rules.json","./icon-192.png","./icon-512.png"];
