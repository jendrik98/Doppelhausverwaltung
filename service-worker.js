const CACHE="mietverwaltung-v17-0-0";
const CORE=["./","./index.html","./style.css","./app.js?v=1602","./v17-upgrade.js?v=1700","./manifest.webmanifest","./legal-rules.json","./icon-192.png","./icon-512.png"];
